        ...
        <div className="flex items-center gap-6">
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-4 text-sm font-bold">
              <span className="text-primary">Amaze Homes</span>
          ...
          <Card className="border-none shadow-sm rounded-[2rem] overflow-hidden">
            ...
            <CardContent className="px-10 pb-10 space-y-10">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-3 p-6 rounded-2xl bg-slate-50/50 border border-slate-100">
                  <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Criticality</label>
                ...
                <div className="space-y-3 p-6 rounded-2xl bg-slate-50/50 border border-slate-100">
                  <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Cap-Ex Budget</label>
                  <div className="h-12 flex items-center text-xl font-bold font-headline">$250,000</div>
                </div>
              </div>

              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Optimization Progress</span>
          ...
          <div className="bg-white rounded-[2rem] shadow-sm border border-slate-50 overflow-hidden">
            <Tabs defaultValue="objectives" className="w-full">
              <TabsList className="h-auto bg-transparent px-10 pt-6 gap-8 border-b rounded-none">
                <TabsTrigger 
                  value="objectives" 
                  className="bg-transparent data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-primary border-b-2 border-transparent rounded-none px-0 pb-4 text-[10px] font-bold uppercase tracking-widest gap-2"
                >
              ...
              <TabsContent value="objectives" className="p-10 space-y-8 m-0">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Active Elements</p>
                    <h3 className="text-xl font-bold font-headline mt-1">Production Objectives</h3>
                  </div>
                  <span className="text-[10px] font-bold text-primary uppercase tracking-widest">0/1 Synced</span>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-6 rounded-2xl bg-white border border-slate-50 group hover:shadow-md transition-all">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        <p className="font-bold text-lg">sdsd</p>
                ...
                <div className="flex justify-center pt-4">
                  <Button variant="ghost" className="text-primary hover:text-primary/80 font-bold text-[10px] uppercase tracking-widest gap-2">
        ...
        <div className="lg:col-span-3 space-y-6">
          <Card className="border-none shadow-sm rounded-3xl overflow-hidden">
            <CardHeader className="p-8 pb-4">
              <CardTitle className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Strategic Talent</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <div className="border-2 border-dashed border-slate-100 rounded-2xl h-24 flex items-center justify-center">
                <Button variant="ghost" className="text-slate-400 font-bold text-[10px] uppercase tracking-widest hover:bg-transparent">
                  Manage Staff
                </Button>
              </div>
            </CardContent>
          ...
          <Card className="bg-[#111827] text-white border-none rounded-[2rem] overflow-hidden shadow-2xl">
            <CardHeader className="p-10 pb-4">
              <CardTitle className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Financial Ledger</CardTitle>
            </CardHeader>
            <CardContent className="p-10 pt-0 space-y-8">
              <div>
                <h2 className="text-4xl font-bold font-headline">$250,000</h2>
                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-2">Deployment Limit</p>
              </div>
              ...
              <Button className="w-full h-14 rounded-2xl bg-white/5 hover:bg-white/10 text-white font-bold text-xs uppercase tracking-widest transition-colors border border-white/10">
                Generate Billing
              </Button>
            </CardContent>
          </Card>
