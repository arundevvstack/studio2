'use server';
/**
 * @fileOverview A hyper-local Genkit flow for generating real-time market research insights.
 * 
...
Analyze current internet search patterns, social media trends (Instagram Reels, TikTok, YouTube Shorts), and industry reports to generate a report including:
...
5. High-demand creative skills (e.g., AI-assisted editing, vertical storytelling, rapid-turnaround VFX).
